...
\033[1;32;40mAnswer all the questions"""
Writertext(banner)

# Input Question
print(" ")
print(" ")
title = input("\033[1;36;40m1. Enter Deface Page Title : ")
print(" ")
time.sleep(1)
img = input("\033[1;36;40m2. Enter Image Link (Location) : ")
print(" ")
time.sleep(1)
Hacker_CN = input("\033[1;36;40m3. Enter Hacker Code Name : ")
print(" ")
time.sleep(1)
message = input("\033[1;36;40m4. Enter Your Message On The Website (You Can Use <br> To Step Line Under) : ")
print(" ")
time.sleep(1)
song = input("\033[1;36;40m5. Enter song link from dropbox(edit dl=0 to 1): ")
print(" ")
time.sleep(1)
...
code11 = """
<p style="font-family: Iceland; font-size : 25px;" align="center"><font style="font-family:Iceland; color : #42f5bc; font-size : 35px;" align="center">Hey Admin<br> <font style="font-family:Iceland; color : #adf2a2; font-size : 30px;" align="center">"""
...
code13 = """</p>
	...
	<br/><br/>"""
code14 = """<center><audio controls autoplay>
<source src='"""
code15 = song
code16 = """' type="audio/ogg"> </audio></center>
</body>
</html>"""
...
if choice == "y":
	time.sleep(3)
	os.system("clear")
	Writertext("\033[1;32;40mWait! Generating your deface page☕🚬")
	time.sleep(2)
